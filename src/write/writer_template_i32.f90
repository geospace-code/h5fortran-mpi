...
call hdf_create(self, dname, dtype=H5T_NATIVE_INTEGER, dims=shape(A, HSIZE_T), dims_file=dims_file, &
filespace=filespace, memspace=memspace, dset_id=dset_id, xfer_id=xfer_id)

call h5dwrite_f(dset_id, H5T_NATIVE_INTEGER, A, dims_file, ierr, &
